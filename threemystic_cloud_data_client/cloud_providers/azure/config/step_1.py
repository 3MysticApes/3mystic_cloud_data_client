...
class cloud_data_client_azure_config_step_1(base):
  ...
  def check_cloud_client(self, *args, **kwargs):
    ...
    if cloud_client.is_provider_config_completed():
      print(f"The client for the provider azure has already been configured. You can Update it now if you would like.")
    ...
    if not cloud_client.is_provider_config_completed():
      print("You must configure the cloud client provider for Azure...")
